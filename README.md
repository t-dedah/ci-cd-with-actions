[![React App CI](https://github.com/t-dedah/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/t-dedah/ci-cd-with-actions/actions/workflows/ci.yml)
